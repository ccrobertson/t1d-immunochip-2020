...
- [Pre-imputation analysis](#pre-imputation-analysis)
- [Define ichip regions](#define-ichip-regions)
- [Post imputation processing](#post-imputation-processing)
- [Imputation coverage and accuracy](#imputation-coverage-and-accuracy)
- [Family-based association analysis](#family-based-association-analysis)
- [Case-control association analysis](#case-control-association-analysis)
- [Meta-analysis](#meta-analysis)
- [Variant annotation](#variant-annotation)
- [Inflation comparison](#inflation-comparison)
- [Fine-mapping](#fine-mapping)
- [cis-caQTL scan](#cis-caqtl-scan)
- [cis-QTL colocalisation](#cis-qtl-colocalisation)
- [Generate BACH2 fine-mapping plots](#generate-bach2-fine-mapping-plots)
