#readin_metal_vcf_newml_res_5pc_diff_dens.R
...
res<-read.table(file=paste0(metdir,"/res/METAANALYSIS_5pcs_vcf_5pc_diff_dens.TBL"), header=T, as.is=T)
...
save(res,file=paste0(metdir,"/res/resultsmeta_5pcs_vcf_5pc_diff_dens.RData"))
...
co<-read.table(file=paste0(metdir,"/res/metal_results_",cohort,"_5pc_diff_dens.tbl"),
header=T, as.is=T)
rownames(co)<-co$SNP
...
out<-out[!(out$Marker %in% c("chr1:113285485:G:A","chr12:111066229:T:C","chr12:112153882:G:A",
"chr12:112731156:C:A")),]

#exporting the regions to a word table:
sink(file=paste0(outputdir,"/res/pmeta_5pcs_vcf_5pc_diff_dens.txt"))
